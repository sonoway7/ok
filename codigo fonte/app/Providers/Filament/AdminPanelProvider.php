        ...
        return $panel
            ...
            ->navigation(function (NavigationBuilder $builder): NavigationBuilder {
                return $builder->groups([
                    ...
                    ,
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Esporte')
                            ->items([
                                ...FootballLeagueResource::getNavigationItems(),
                                ...FootballEventResource::getNavigationItems(),
                                ...SportBetResource::getNavigationItems(),
                            ])
                        : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Ajustes Jogos')
                            ->items([
                                ...CasinoCategoryResource::getNavigationItems(),
                    ...
                    auth()->user()->hasRole('admin') ?
                        NavigationGroup::make('Jogos')
                            ->items([
                                ...
                                ...CasinoGamesSlotgratorResource::getNavigationItems(),
                                ...CasinoGamesSalsaResource::getNavigationItems(),
                            ])
                        : NavigationGroup::make()
                    ,
                    auth()->user()->hasRole('admin') ?
