                                ...
                                <form @submit.prevent="registerSubmit" method="post" action="" class="">
                                    ...
                                    <div class="mb-3">
                                        <div class="flex items-center">
                                            ...
                                            <label for="term-agreement" class="ml-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ $t('I agree with the') }} <a href="#" class="text-blue-600 dark:text-blue-500 hover:underline">{{ $t('terms and conditions') }}</a>.</label>
                                        </div>
                                    </div>
