<template>
    <div :key="index" class="game-list flex flex-col mt-5 relative">
        <div class="w-full flex justify-between mb-3">
            ...
            <div class="flex">
                <RouterLink
                    :to="{ name: 'casinosAll', params: { provider: 'salsa', game: category.slug } }"
        ...
        >
            ...
            <Slide v-if="category.games_salsa && !isLoading" v-for="(game, igame) in category.games_salsa" :index="igame">
                <CassinoGameCard
                    :index="igame"
                    :title="game.name"
