<template>
    <div class="block">
        <div v-if="paymentType === null && wallet && setting">
            <div class="">
                <ul>
                    <li v-if="setting.suitpay_is_enable" @click="setPaymentMethod('pix')" class=" bg-white dark:bg-gray-700 cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-3">
                        <div>
                    ...
                    <li v-if="setting.stripe_is_enable" @click="setPaymentMethod('stripe')" class="bg-white dark:bg-gray-700 cursor-pointer flex justify-between hover:bg-green-700/20 px-4 py-3 mb-2">
                        <div>
